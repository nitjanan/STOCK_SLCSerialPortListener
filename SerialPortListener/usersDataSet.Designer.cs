...
namespace SerialPortListener {
    ...
    public partial class usersDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usersRow AddusersRow(int users_id, string firstname, string lastname, string username, string password, string permission) {
...
namespace SerialPortListener.usersDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Devart.Data.PostgreSql.PgSqlParameter();
            param.ParameterName = "IsNull_permission";
            param.DbType = global::System.Data.DbType.Int32;
            param.PgSqlType = global::Devart.Data.PostgreSql.PgSqlType.Int;
            param.IsNullable = true;
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::Devart.Data.PostgreSql.PgSqlParameter();
            param.ParameterName = "Original_permission";
            param.PgSqlType = global::Devart.Data.PostgreSql.PgSqlType.Text;
            param.IsNullable = true;
            param.SourceColumn = "permission";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"public\".\"users\" (\"users_id\", \"firstname\", \"lastname\", \"username\", \"p" +
                "assword\", \"permission\") VALUES (:users_id, :firstname, :lastname, :username, :pa" +
                "ssword, :permission)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""public"".""users"" SET ""users_id"" = :users_id, ""firstname"" = :firstname, ""lastname"" = :lastname, ""username"" = :username, ""password"" = :password, ""permission"" = :permission WHERE ((""users_id"" = :Original_users_id) AND ((:IsNull_firstname = 1 AND ""firstname"" IS NULL) OR (""firstname"" = :Original_firstname)) AND ((:IsNull_lastname = 1 AND ""lastname"" IS NULL) OR (""lastname"" = :Original_lastname)) AND ((:IsNull_username = 1 AND ""username"" IS NULL) OR (""username"" = :Original_username)) AND ((:IsNull_password = 1 AND ""password"" IS NULL) OR (""password"" = :Original_password)) AND ((:IsNull_permission = 1 AND ""permission"" IS NULL) OR (""permission"" = :Original_permission)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        users_id, firstname, lastname, username, \"password\", permission\r\nFR" +
                "OM            users";
        ...
        public virtual int Delete(int Original_users_id, string Original_firstname, string Original_lastname, string Original_username, string Original_password, string Original_permission) {
        ...
        public virtual int Insert(int users_id, string firstname, string lastname, string username, string password, string permission) {
        ...
        public virtual int Update(int users_id, string firstname, string lastname, string username, string password, string permission, int Original_users_id, string Original_firstname, string Original_lastname, string Original_username, string Original_password, string Original_permission) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstname, string lastname, string username, string password, string permission, int Original_users_id, string Original_firstname, string Original_lastname, string Original_username, string Original_password, string Original_permission) {
            return this.Update(Original_users_id, firstname, lastname, username, password, permission, Original_users_id, Original_firstname, Original_lastname, Original_username, Original_password, Original_permission);
        }
    }
